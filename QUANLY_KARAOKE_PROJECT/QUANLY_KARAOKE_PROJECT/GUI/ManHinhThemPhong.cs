    ...
    public partial class ManHinhThemPhong : Form
    {
        ...
        private void BindGrid(List<PHONG> listPhong)
        {
            ...
            foreach (var p in listPhong)
            {
                ...
                dataGridView1.Rows[index].Cells[3].Value = p.TrangThai;
                dataGridView1.Rows[index].Cells[4].Value = p.HienDung;
                dataGridView1.Rows[index].Cells[5].Value = p.LOAI_PHONG.Gia;
            }
        }
